...
import toObject from "../../../services/engine/utils/misc/toObject";
    ...
    useHotKeys({
        ...
        actions: [
            ...
            },
            {
                ...
                callback: () => {
                    const obj = {}
                    hook.selected.forEach(a => {
                        obj[a] = a
                    })
                    hook.setLinks(prev => {
                        return prev.filter(e => obj[e.target.id] === undefined && obj[e.source.id] === undefined)
                    })
                    hook.setNodes(prev => {
                        return prev.filter(e => obj[e.id] === undefined)
                    })
