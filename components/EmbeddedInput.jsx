...
import {Dropdown, DropdownOption, DropdownOptions, Icon, TextField} from "@f-ui/core"
                        ...
                        <Dropdown
                            ...
                            <DropdownOptions>
                                ...
                                <DropdownOption
                                    option={{
                                        label: "Yes",
                                        icon: !bundledVariable ? null : <Icon
                                            styles={{fontSize: "1.1rem"}}>check</Icon>,
                                        onClick: () => {
                                            props.submit(true)
                            ...
                            <div className={styles.header}>
                                ...
                                <DropdownOption
                                    option={{
                                        ...
                                        icon: <Icon
                                            style={{fontSize: "1.1rem"}}>clear</Icon>,
                                        onClick: () => {
